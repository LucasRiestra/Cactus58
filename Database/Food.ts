...
export const ArepasArray: Arepa[] = [{
    id: 1,
    ...
    name: "Pollo y queso:",
    price: 6.90,
    img: "https://res.cloudinary.com/dtqgzojs3/image/upload/v1709890865/Cactus58/Arepa_pollo_queso_fondo_negro_wyzose.png",
    ...
    description: "Queso latino a la plancha y aguacate. Bautizada así en Cactus 58 para nuestro gran público español y por su alta demanda."
}
]

export const TequeñosArray: Tequeños[] = [
    {
    id: 1,
    price: 7,
    img: "https://res.cloudinary.com/dtqgzojs3/image/upload/v1709891058/Cactus58/Teque%C3%B1os_fondo_negro_otqtf3.png",
}, 
]
...
export const CachitosArray: Cachitos[] = [
    {
    id: 1,
    price: 2.80,
...
export const SalchipapaArray: Salchipapa[] = [
    {
    id: 1,
    name: "Normal:",
    price: 10,
    img: "https://res.cloudinary.com/dtqgzojs3/image/upload/v1709891547/Cactus58/Salchipapa_Clasica_fondo_negro_mncyfp.png",
},  {
    id: 2,
    name: "Con Pollo",
    price: 14,
    ...
    name: "Mixta",
    price: 14,
    img: "https://res.cloudinary.com/dtqgzojs3/image/upload/v1709891577/Cactus58/Salchi_mixta_fondo_negro_wksbpl.png",
}
]

export const PerritoArray: PerritoLatino[] = [
    {
    id: 1,
    price: 10,
    img: "https://res.cloudinary.com/dtqgzojs3/image/upload/v1709891649/Cactus58/Perro_Latino_fondo_negro_l9lvlq.png",
}, ]

export const PepitoArray: Pepito[] = [
    {
    id: 1,
    price: 12,
    img: "https://res.cloudinary.com/dtqgzojs3/image/upload/v1709891648/Cactus58/Pepito_Latino_Fondo_negro_ht34n8.png",
}, ]

export const CachapasArray: Cachapas[] = [{
    id: 1,
    name: "Ternera y Queso:",
    price: 8.90,
